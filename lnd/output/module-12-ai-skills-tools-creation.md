...
Optional: the AgentSkills.io standard proposes a machine-readable format for packaging `skills`. It is useful for sharing across teams, but colocating `instructions` with `tools` in your project is sufficient for individual use.
