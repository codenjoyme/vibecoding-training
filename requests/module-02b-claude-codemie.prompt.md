...
Когда будешь запускать этот промпт смотри на git diff и увидишь что я добавил. Эти заметки и улучшай. Остальное остается для контекста - стейтменты что уже есть - исправления были сделаны ранее и их не надо поломать. 
</instructions>
