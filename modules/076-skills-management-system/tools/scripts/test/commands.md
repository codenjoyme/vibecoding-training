...
Flags:
  -json
    	Output skills as JSON array
  -verbose
    	Show description and owner from info.json
...
Flags:
  -groups value
    	Groups to initialize (comma-separated or repeated flag; positional args also accepted)
  -repo string
