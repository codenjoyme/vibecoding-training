...
export declare function addToSparseCheckout(repoDir: string, skillName: string): void;
...
export declare function stashSkillChanges(repoDir: string, skillName: string): void;
