...
```
[master (root-commit) b89a934] Initial commit
...
> `skills disable alpha-skill`
```
Error: Skill "alpha-skill" is already disabled
```
...
> `skills enable group group-1`
```
Error: Group "group-1" is already enabled
```
...
> `skills disable group group-1`
```
Error: Group "group-1" is not currently enabled
```
...
> `git log --oneline --all`
```
7feae89 feat(alpha-skill): update skill instructions
145012e feat(gamma-skill): update skill instructions
d9f8126 feat(beta-skill): update skill instructions
239ee10 feat(alpha-skill): update skill instructions
b89a934 Initial commit
```
...
> `git log --oneline`
```
3f16d10 feat(beta-skill): update skill instructions
7feae89 feat(alpha-skill): update skill instructions
145012e feat(gamma-skill): update skill instructions
d9f8126 feat(beta-skill): update skill instructions
239ee10 feat(alpha-skill): update skill instructions
...
```
1f888fb feat(delta-skill): add to groups group-1
86542e9 feat(delta-skill): update skill instructions
```
...
```
1f888fb feat(delta-skill): add to groups group-1
5287694 feat(epsilon-skill): add to groups new-group
86542e9 feat(delta-skill): update skill instructions
442437f feat(epsilon-skill): update skill instructions
3f16d10 feat(beta-skill): update skill instructions
7feae89 feat(alpha-skill): update skill instructions
145012e feat(gamma-skill): update skill instructions
d9f8126 feat(beta-skill): update skill instructions
