...
**Skill:** Call REST APIs directly from terminal using curl — bypassing LLM for reliable, token-efficient tool execution
...
- Why calling tools directly (without LLM in the middle) avoids hallucinations
