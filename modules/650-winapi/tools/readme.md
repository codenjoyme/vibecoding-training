...
![Финальный кадр: снег идёт на google.com, рядом видно как агент рассуждает](../../../requests/650-winapi/img/00-final-result.png)
...
ключ `"servers"` (у Cursor было бы `"mcpServers"`).
...
![mcp.json с winapi-mcp и логом "Discovered 11 tools"](../../../requests/650-winapi/img/06-mcp-server-registered.png)
...
![Configure Tools — все 11 winapi-mcp инструментов включены](../../../requests/650-winapi/img/07-tools-enabled.png)
...
![01 — Chrome со страницей google.com на переднем плане](../../../requests/650-winapi/img/01-chrome-google-loaded.png)
...
![02 — DevTools открыт, активна вкладка Elements](../../../requests/650-winapi/img/02-devtools-elements.png)
...
![03 — Активна вкладка Console, поле ввода готово](../../../requests/650-winapi/img/03-console-tab-ready.png)
...
![04 — предупреждение "Don't paste code into the DevTools Console"](../../../requests/650-winapi/img/04-paste-protection-warning.png)
...
![05 — снег идёт на google.com](../../../requests/650-winapi/img/05-snow-running.png)
