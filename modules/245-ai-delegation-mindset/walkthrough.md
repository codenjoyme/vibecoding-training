...
2. Fill this template with your real task details (you can prepare it in a text editor first), keep the full markdown structure, then paste and send the whole filled template as one message in your AI assistant chat:
