...
2. Fill this template with your real task details (you can prepare it in a text editor first), then paste and send the complete filled template as one message in your AI assistant chat:
