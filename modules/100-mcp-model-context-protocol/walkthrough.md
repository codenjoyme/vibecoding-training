...
2. **Copy the VS Code configuration template**
   ...
   A template file is provided at: `./modules/100-mcp-model-context-protocol/tools/.vscode/mcp.json`
   ...
   ```json
   {
     "servers": {
       "echo-windows": {
         "command": "powershell",
         "args": ["-ExecutionPolicy", "Bypass", "-File", "./modules/100-mcp-model-context-protocol/tools/mcp-echo.ps1"]
       },
       "echo-unix": {
         "command": "bash",
         "args": ["./modules/100-mcp-model-context-protocol/tools/mcp-echo.sh"]
       }
     }
   }
   ```
...
2. **Copy the Cursor configuration template**
   ...
   A template file is provided at: `./modules/100-mcp-model-context-protocol/tools/.cursor/mcp.json`
...
6. **Test each tool**
   ...
   **Test list_files:**
   ```
   Use list_files to show all .md files in the ./modules/ directory
   ```
   
   **Test search_files:**
   ```
   Use search_files to find the word "MCP" in all files under ./modules/100-mcp-model-context-protocol/
   ```
...
## Part 6: Understanding Check & Quiz
