...
| [058-workspace-kickoff-iterative-prompt](modules/058-workspace-kickoff-iterative-prompt/) | base | optional | Create a kickoff prompt file that grows with UPD blocks — the iterative prompt approach for evolving investigations |
